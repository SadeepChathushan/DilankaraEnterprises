...
//             padding: const EdgeInsets.all(18),
//             child: widget.isGridItem
//                 ? _buildGridLayout(d, date)
//                 : _buildListLayout(d, date),
//           ),
//         ),
//       ),
//     );
...
//   Widget _buildListLayout(Delivery d, String date) {
//     return Row(
//       children: [
//         Container(
//           width: 60,
//           height: 60,
//           decoration: BoxDecoration(
//             gradient: const LinearGradient(colors: [Color(0xFFE87A0D), Color(0xFFFF9E3D)]),
//             borderRadius: BorderRadius.circular(16),
//             boxShadow: [
//               BoxShadow(color: const Color(0xFFE87A0D).withOpacity(0.4), blurRadius: 10, offset: const Offset(0, 4)),
//             ],
//           ),
//           child: const Icon(Icons.local_shipping_rounded, color: Colors.white, size: 30),
//         ),
...
//               ),
//               const SizedBox(height: 4),
//               Text(date, style: TextStyle(fontSize: 13, color: Colors.white.withOpacity(0.7))),
//               const SizedBox(height: 10),
//               // Row(
//               //   mainAxisSize: MainAxisSize.min,
//               //   children: [
...
//   Widget _buildGridLayout(Delivery d, String date) {
//     return Column(
//       crossAxisAlignment: CrossAxisAlignment.start,
//       children: [
//         Row(
